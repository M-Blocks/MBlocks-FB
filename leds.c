...
#	if (I2C_SLAVE_ADDR == 1)
#		define PORT_LED_ANODE_TOP			PORT_LED_ANODE2
#		define PIN_NUMBER_LED_ANODE_TOP		PIN_NUMBER_LED_ANODE2
#		define PORT_LED_ANODE_BOTTOM		PORT_LED_ANODE1
#		define PIN_NUMBER_LED_ANODE_BOTTOM	PIN_NUMBER_LED_ANODE1
